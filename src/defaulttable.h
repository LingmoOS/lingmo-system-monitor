...
static const PrettyTableItem default_table[] = {
  /* Lingmo services */
  ITEM (".*applet(-?2)?|lingmo-panel", "lingmo-panel"),
  ITEM ("evolution.*", "emblem-mail"),
  ITEM ("gconfd-2|dconf-service", "preferences-desktop"),
  ITEM ("metacity|lingmo-shell", "lingmo-window-manager"),
  ITEM ("vino.*", "lingmo-remote-desktop"),
  /* Other processes */
  ...
  ITEM ("emacs(server|\\d+)?", "lingmo-emacs"),
  ...
  ITEM ("squid", "proxy"),
  ITEM ("ssh(d|-agent)", "ssh-askpass-lingmo"),
